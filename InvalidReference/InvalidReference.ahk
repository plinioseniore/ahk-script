;----------------------------------
; Auto InvaldReference Detectr
;----------------------------------
;
;	This script make the screenshoots of all the HMI pages with invalid reference
;	of the Experion System
;

; Variables
AbstractFolder = C:\Program Files\Honeywell\Experion PKS\Client\Abstract
ScreenShootsFolder = C:\Program Files\Honeywell\Experion PKS\Client\Abstract\ScreenShootsInvaldReference
...
Send, mkdir ScreenShootsInvaldReference{Enter}
