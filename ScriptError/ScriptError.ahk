;----------------------------------
; Auto Script Error Detector
;----------------------------------
;
;	This script make the screenshoots of all the HMI pages with script's errors
;	of the Experion System
;

; Variables
AbstractFolder = C:\Program Files\Honeywell\Experion PKS\Client\Abstract
ScreenShootsFolder = C:\Program Files\Honeywell\Experion PKS\Client\Abstract\ScreenShootsScriptError
...
Send, mkdir ScreenShootsScriptError{Enter}
...
Loop, read, %AbstractFolder%\list.txt
{
	...
	; Wait for 3 second for (if any) an error window
	WinWait, Error, , 3
